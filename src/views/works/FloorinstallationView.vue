...
<div class="container m-2">
  ...
  <section class="hero">
    <img rel="preload" src="@/assets/main_tiles_W1920.webp"
         alt="tiles in compact manner" class="hero__img" fetchpriority="high" decoding="async"/>
    <div class="hero__overlay">
      <AnimatedSection animation="fade-in" :delay="0.2">
        <h2 class="text-center hero__title">
          <AnimatedText text="Tegels, Parket & Laminaat" :base-delay="0.2" :stagger="0.1"/>
        </h2>
      </AnimatedSection>
    </div>
  </section>
